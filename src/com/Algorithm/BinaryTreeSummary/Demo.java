package com.Algorithm.BinaryTreeSummary;
...
public class Demo {
	...
	/**
	 * 前序遍历迭代解法：用一个辅助stack，总是把右孩子放进栈 http://www.youtube.fcom/watch?v=uPTCbdHSFg4
	 */
	public static void preoderTravelsal(TreeNode root) {
		if (root == null) {
			return;
		}
     ...
     *   
     *  这是我目前见到的最好的递归解法！ 
     *  http:nt/discuss.leetcode.com/questions/49/binary-tree-level-order-traversal#answer-container-2543 
     */  
