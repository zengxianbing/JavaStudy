...
class FileAttributesExample {
  /*  // Demonstrates the BasicFileAttributeView
    ...
    private static void fileOwnerAttributesExample(Path attribPath) throws Exception {
        ...
        FileOwnerAttributeView ownerView = attribPath.getFileAttributeView(FileOwnerAttributeView.class);
    ...
    private static void fileSpaceAttributesExample(Path attribPath) throws Exception {
        ...
        for (FileStore fileStore: FileSystems.getDefault().getFileStores()) {
            ...
            FileStoreSpaceAttributeView spaceView = fileStore.getFileStoreAttributeView(FileStoreSpaceAttributeView.class);
            FileStoreSpaceAttributes spaceAttribs = spaceView.readAttributes();

            // Print the attributes for this FileStore
            System.out.println("FileStore " + fileStore + " has the following FileStoreSpaceAttributes:");
            System.out.println("   Total space = " + spaceAttribs.totalSpace());
            System.out.println("   Unallocated space = " + spaceAttribs.unallocatedSpace());
            System.out.println("   Usable space = " + spaceAttribs.usableSpace());
        }
        System.out.println();
    }
